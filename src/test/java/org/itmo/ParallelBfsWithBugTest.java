...
@State
public class ParallelBfsWithBugTest {
    ...
    public ParallelBfsWithBugTest() {
        RandomGraphGenerator gen = new RandomGraphGenerator();
        int edges = SIZE * (SIZE - 1);
        g = gen.generateGraph(new Random(42), SIZE, edges);
    }

    @Actor
    public void actor1() {
        a1 = g.parallelBFSWithBugs(START);
    }

    @Actor
    public void actor2() {
        a2 = g.parallelBFSWithBugs(START);
    }
